...
module OVO_TemplateInterface_Summarizer
  ...
  class CSVFormatter
    ...
    COLUMNS = [
      ...
      %w[c/Severities            core.severities],
      %w[c/Nodes                 core.nodes],
      %w[c/Application           core.application],
      %w[c/MessageGroup          core.msggrp],
      %w[c/Object                core.object],
      %w[c/Text                  core.text],
      %w[c/TextOptions           core.text_options],
      %w[!/Mode                  mode],
    ...
    SET_DEFINES = OpenViewOperations::Templates::Parser::OPCMSG.set_defines
